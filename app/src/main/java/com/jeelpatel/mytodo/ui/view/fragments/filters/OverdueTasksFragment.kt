...
import com.jeelpatel.mytodo.databinding.FragmentOverdueTasksBinding
...
class OverdueTasksFragment : Fragment() {
    ...
    private var _binding: FragmentOverdueTasksBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentOverdueTasksBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        taskAdapter = TaskAdapter(
            ...
            onTaskClick = { task ->
                val action =
                    OverdueTasksFragmentDirections.actionOverdueTasksFragmentToTaskViewFragment(
                        task.taskId,
                        task.title,
